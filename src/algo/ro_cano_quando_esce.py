...
class ro_cano_quando_esce(object):
    ...
    def action(self):
        ...
        if self.open and self.session and last_trade_action != 'buy' and ma8_last >= ma34_last and (macd < 1.2 or ((ma7_last / ma34_last - 1) * 100 > 0.26) and macd > 1) and ma1_last > ma34_last:
