...
class ro_cano_quando_esce(object):
    ...
    def action(self):
        ...
        # compra o vende solo se ma8 >= ma34 ed anche (macd proper < 1.2 oppure se ((ma8 / ma34 - 1) * 100 > 0.26) and macd > 1)
        if (self.open and self.session and last_trade_action != 'buy'
            and ma8_last >= ma34_last
            and (macd < -1.0 or ((ma7_last / ma34_last - 1) * 100 > 0.26) and macd > 1)
