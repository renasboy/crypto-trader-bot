        ...
        if self.open and self.session and last_trade_action != "buy":
            ...
            #############################################################################################################      COMPRA sessione 2
                ...
                # BUY 2 RIVOLUZIONARIO A3 (100 NON E' ATTACCATA ALLA 300 !) e 39>50 E 8>200 and deviation_ma100_sopra_ma300 > 0.05 
                    ...
                    buy = "BUY 2 RIVOLUZIONARIO A3 con 100 CHE NON E' ATTACCATA ALLA 300 ! e 8>50 and 5>200 - r 5945 A3"
                    action = "buy"
                    percentage = 70
            ...
            if self.session == 1:
                ...
                # VENDITA - da 90 minuti a 110 minuti  = da 5400 secondi a 6600 secondi
                    ...
                    # con or IL MAESTRO HA FATTO LA CORREZIONE ! questa che vedi e' stata corretta dal maestro
                        ...
                        sell = "SELL 1 90-110 min con ma50 < and ma100 < and (deviation_sell < -0.15 and ma3_last < ma39_last) 300 < 120 min ago - r 10170 A"
                        action = "sell"
                        
                        # 27 giu 2022 dev sell 0.145 da 0.15
                        
                        # > estate -0.14 da -0.145
                        # 15 dic dev sell -0.15 da -0.14 con doppio delta 300-100 giorno
