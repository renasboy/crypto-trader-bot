        ...
        if self.open and self.session and last_trade_action != "buy":
            ...
            if self.session == 1:
                ...
                # BUY 1 che ci riprova quando se ne va lateralmente dopo il crollo
                    ...
                    buy = "BUY 1 che ci riprova quando se ne va lateralmente dopo il crollo - SE 28 < 300 - r 4082 a1X"
                    action = "buy"
                    percentage = 80
                ...
                # BUY 1 che ci riprova quando se ne va lateralmente dopo il crollo
                    ...
                    buy = "BUY 1 che ci riprova quando se ne va lateralmente dopo il crollo - SE 28 < 300 - r 4082 a1Y"
                    action = "buy"
                    percentage = 80
