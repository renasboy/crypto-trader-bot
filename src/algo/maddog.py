        ...
        if self.open and self.session and last_trade_action != "buy":
            ...
            if self.session == 1:
                ...
                # BUY 1 migliore che considera distanza 5-300 AND dev 10-200 < -0.24 AND 8-59 - riga 1043 B
                    ...
                    and deviation_ma59_sopra_ma300 < -0.15
            ...
            if self.session == 1:
                ...
                # VENDITA - da 21 a 50 minuti = da 1261 a 3000 secondi
                    ...
                    # TREND LATERALE (100/300  <0.69 and >-0.77) NON TOCCARE 
                        ...
                        sell = "SELL 1 NON TOCCARE (21-50 min) con ma50 < con dev_ma39 <-0.17 E dev_sell < -0.22 TREND LATERALE (100>300 <0.69 and >-0.77) - r 9016a"
                        action = "sell"
