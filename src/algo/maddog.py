        ...
        if self.open and self.session and last_trade_action != "buy":
            ...
            if self.session == 1:
                ...
                # ------------------------------------------------------ BUY 1 MOLTO RISCHIOSO modo 1 ! quando incomincia il ribasso MA ma300 120 > E ma200 120 >
                    ...
                    buy = "BUY 1 - 80% - RISCHIOSO ! incomincia il ribasso MA ma300 120 > e ma200 120 > ANCORA IN RIALZO ! E 200 > 300 e 3-10 > 0.10 - r 1088 A1"
                    action = "buy"
                    percentage = 80
                ...
                # BUY 1 tempo INIZIO AUTUNNO (200 > 200 120 min) che considera il passare del tempo con ma30 > MA 100 < 200
                    ...
                    buy = "BUY 1 tempo INIZIO AUTUNNO (200 > 200 120 min ago) che considera il passare del tempo con 5-28 > 0.15 and 200>300 - r 1586 a"
                    action = "buy"
                    percentage = 80
                ...
                # BUY 1 SITUAZIONE TREND LATERALE che mancava con ma300 < - DOPPIO DELTA - RIALZO
                    ...
                    buy = "BUY 1 SITUAZIONE TREND LATERALE che mancava con ma300 < - SOPRA RIALZO RIALZO - GIORNO ! and 5-28 > 0.14 - riga 4301"
                    action = "buy"
                    percentage = 80
                ...
                # BUY 1 FOREVER YOUNG PRUDENTE se ma 200 > e se ma200 > ma300 con doppio delta > 1 (ribasso) and deviation_ma5_sopra_ma28 > 0.30
                    ...
                    buy = "BUY 1 FOREVER YOUNG PRUDENTE SOPRA RIBASSO RIBASSO - NOTTE - and dev_ma5_sopra_ma28 > 0.30 se ma 200 > e se ma200 > ma300 - r 4440 a"
                    action = "buy"
                    percentage = 80
                ...
                # BUY 1 FOREVER YOUNG PRUDENTE se ma 200 > e se ma200 > ma300 con doppio delta > 1 (ribasso) and deviation_ma5_sopra_ma28 > 0.30
                    ...
                    buy = "BUY 1 FOREVER YOUNG PRUDENTE SOPRA RIBASSO RIBASSO - NOTTE - and dev_ma5_sopra_ma28 > 0.30 se ma 200 > e se ma200 > ma300 - r 4466 b"
                    action = "buy"
                    percentage = 80
                ...
                # ( E ANCHE la ma25 deve stare un po' distante dalla 300 !!! )
                    ...
                    buy = "BUY 1 FIAT (MA ma100 ANCORA VICINA alla ma300 e 200 e' ancora >300) (E CON ma25 distante da ma300) 50% E 78<100 E 3-10>0.12- riga 4514 B"
                    action = "buy"
                    percentage = 50
            ...
            #############################################################################################################      COMPRA sessione 2
                ...
                # BUY 2 DURANTE UN RIBASSO AUDI CHE NON E' UN CROLLO ! E CHE CI RIPROVA (compare stammi vicino!)
                    ...
                    buy = "BUY 2 DURANTE UN RIBASSO AUDI CHE NON E' UN CROLLO ! E CHE CI RIPROVA con 5 > 22 - riga 4905"
                    action = "buy"
                    percentage = 80
                    ...
                    # 9 luglio ho messo 5>22 perche' cosi' e' chiaro chi interviene e counque 5-16>0.08 era arrivata molto tardi e 5-16 arriva una ndecchia prima
                ...
                # BUY 2 CHE MANCAVA DOPO 5 ore di ribasso
                    ...
                    buy = "BUY 2 CHE MANCAVA DOPO 5 ore di ribasso buy con 5-28 - r 5979"
                    action = "buy"
                    percentage = 80
            ...
            if self.session == 1:
                ...
                # VENDITA - da 21 a 50 minuti = da 1261 a 3000 secondi
                    ...
                    ############################################################################## CUSCINO DI SANT' ANTONIO per questo segmento di tempo !
                        ...
                        sell = "SELL 1 (21-50 min) con ma50 > and 5-100 and deviation_sell < -0.32 CUSCINO DELLA MADONNA se ma100 < MA 300 > E 40 > 100 - r 8922 A"
                        action = "sell"
                        ...
                        sell = "SELL 1 (21-50 min) con ma50 > and 5-100 and deviation_sell < -0.27 CUSCINO DELLA MADONNA se ma100 < MA 300 > E 40 < 100 - r 8922 B"
                        action = "sell"
                    ...
                    # SELL 1 eventuale guadagno dopo BUY AUDI E crollo SUCCESSIVO (21-50 min) 
                        ...
                        sell = "SELL 1 eventuale guadagno dopo BUY AUDI E crollo SUCCESSIVO (21-50 min) - r 9312"
                        action = "sell"
                ...
                # VENDITA - da 50 a 90 min - da 3001 a 5400 secondi in poi
                    ...
                    ##################################################### sempre con ma50 discendente MA trend ma200> ET ma200 > ma300 - PERDITA TOLLERATA AUMENTA
                        ...
                        sell = "SELL 1 da 50-90 min BEST sempre con ma50< MA 78 < 200 con dev_ma39 <-0.23 and dev_sell <-0.295 - CON PERDITA TOLLERATA > - r 9828 B"
                        action = "sell"
                    ...
                    # AGGIUNTA TARDIVA MA FORSE NECESSARIA !
                        ...
                        sell = "SELL 1 da 50-90 min AGGIUNTA TARDIVA MA FORSE NECESSARIA ! and delta_1 < delta_2 and deviation_sell < -0.185 e 300<5 ore - r 9888 a2"
                        action = "sell"
            ...
            # ALLA SESSIONE 2 MANCAva UN ACQUISTO DURANTE IL CROLLO SE PER ES SESSIONE 1 HA GIA' VENDUTO MA IL TITOLO RESTA IN IPERVENDUTO
                ...
                # VENDITA - da 21 a 60 minuti = da 1261 a 3600 secondi
                    ...
                    ##############################################################################################################################
                        ...
                        sell = "SELL 2 (21-60 min) con ma50 > and 5<39 and deviation_sell 0.25 - 0.56 MARADONA e' piu' stanco e paziente - r 11477 a"
                        action = "sell"
                        ...
                        sell = "SELL 2 (21-60 min) con ma50 > and 5<48 and deviation_sell 0.25 - 0.56 MARADONA e' piu' stanco e paziente - r 11477 b"
                        action = "sell"
            ...
            ################################################################################################### SESSIONE 3
                ...
                ###################################################################### RIGHE DEL COMPA DA RADDOPPIAte PER AUMENTARE LA TOLLERANZA
                    ...
                    if (    
                        ...
                        sell = "SELL 3 >60 min con ma50> and 4-18 and deviation_sell 0.57-0.90 DRIBBLING ALLA RONALDO - r 13915"
                        action = "sell"
