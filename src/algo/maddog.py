class maddog:
    ...
    def action(self):
        ...
        if self.open and self.session and last_trade_action != "buy":
            ...
            if self.session == 1:
                ...
                # ------------------------------------------------------------ BUY 1 MOLTO RISCHIOSO modo 1 ! quando incomincia il ribasso MA ma300 >
                    ...
                    buy = "BUY 1 MOLTO RISCHIOSO modo 1 ! quando incomincia il ribasso MA ma300 E' ANCORA IN RIALZO ! - r 884"
                    action = "buy"
                    percentage = 50
                ...
                # BUY 1 se ma200> and ma300 > and 8>50 AND ma78 < AND 8 > 78 AND 5-28 > 0.11 
                    ...
                    buy = "BUY 1 con 20>200 and 69 > 100 and deviation_bellissima > 0.14 AND ma78 > AND 8 > 78 AND 5-28 > 0.11  - r 977"
                    action = "buy"
                    percentage = 50
                ...
                # BUY 1 PERICOLOSA derivata dal tardo autunno ! togliendo i 40 minuti della ma30 
                    ...
                    buy = "BUY 1 PERICOLOSA 39< derivata dal tardo autunno ! togliendo i 40 minuti della ma30 con 11-59 con 5-28 > 0.20 - r 1060"
                    action = "buy"
                    percentage = 50
                ...
                # BUY 1 MISTERO con INCROCIO 8-50 E 5-28 PIU' BASSO per arrivare una ndecchia prima del passare del tempo. prendendo rischio
                    ...
                    buy = "BUY 1 MISTERO con INCROCIO 8-50 e 5-28 > 0.14 per arrivare una ndecchia prima del passare del tempo prendendo rischio - riga 1397"
                    action = "buy"
                    percentage = 50
                ...
                # BUY 1 piccola CORREZIONE FIAT = r 701 RCCR ma con rischio ridotto !
                    ...
                    buy = "BUY 1 piccola CORREZIONE FIAT = r 701 RCCR ma con rischio ridotto ! - r 1971"
                    action = "buy"
                    percentage = 40
                ...
                # BUY 1 DURANTE UN RIBASSO AUDI PIU' LENTA LENTA copiata da RCCR CHE E' ANDATA BENISSIMO CHE NON E' UN CROLLO ! (compare stammi vicino!)
                    ...
                    buy = "BUY 1 DURANTE UN RIBASSO AUDI PIU' LENTA CHE NON E' UN CROLLO ! and delta_1 < delta_2 con dev 5-16 > 0.12 - riga 2515 A"
                    action = "buy"
                    percentage = 50
                ...
                # BUY 1 DURANTE UN RIBASSO AUDI PIU' LENTA LENTA copiata da RCCR CHE E' ANDATA BENISSIMO CHE NON E' UN CROLLO ! (compare stammi vicino!)
                    ...
                    and ma2_last > ma2_2_min_ago
                    and ma78_last < ma200_last
                    and deviation_ma5_sopra_ma16 > 0.14
                ):
                    buy = "BUY 1 DURANTE UN RIBASSO AUDI PIU' LENTA CHE NON E' UN CROLLO ! and delta_1 > delta_2 con dev 5-16 > 0.14  - riga 2515 B"
                    action = "buy"
                    percentage = 50
                ...
                # BUY 1 CHE MANCAVA aggressiva - (SEMBRA pari al BUY DURANTE UN RIBASSO AUDI !)
                    ...
                    buy = "BUY 1 CHE MANCAVA aggressiva 5-28 > 0.08 (SEMBRA pari al BUY DURANTE UN RIBASSO AUDI !) - r 3042"
                    action = "buy"
                    percentage = 30
            ...
            #############################################################################################################      COMPRA sessione 2
                ...
                # --------------------------------------- BUY 2 che entra in azione se ma2 va sopra SELL 1 di almeno 0.45 !
                    ...
                    buy = "BUY 2 che entra in azione se DOPO 2 MINUTI ma2 va sopra SELL 1 > 0.45 ! - r 4187"
                    action = "buy"
                    percentage = 40
        ...
        # NON TOCCARE QUESTE RIGHE (DICE CHE STA IN MODO SELL, DEVO VENDERE !)
            ...
            if self.session == 1:
                ...
                # VENDITA - da 21 a 50 minuti = da 1261 a 3000 secondi
                    ...
                    ################################################################################################ con ma100 DISTANTE sopra dalla ma300
                        ...
                        sell = "SELL 1 (21-50 min) con ma50 < con deviation_ma39 <-0.16 TREND CRESCITA (100 sopra 300 > 0.69) - r 7017"
                        action = "sell"
                    ...
                    #####################################################################################
                        ...
                        sell = "SELL 1 (21-50 min) con ma50 < e 100< and INCROCIO 3-100 (no 3<100) CUSCINO DI SANT' ANTONIO and deviation_sell < -0.29 - r 7196"
                        action = "sell"
            ...
            # POCHI MALEDETTI E SUBITO ma non troppo 3-28 mentre sale
            ...
            # POCHI MALEDETTI E SUBITO ma non troppo mentre scende
