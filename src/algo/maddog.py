            ...
            # ALLA SESSIONE 2 MANCAva UN ACQUISTO DURANTE IL CROLLO SE PER ES SESSIONE 1 HA GIA' VENDUTO MA IL TITOLO RESTA IN IPERVENDUTO
                ...
                # VENDITA - da 21 a 60 minuti = da 1261 a 3600 secondi
                    ...
                    if (        
                        ...
                        sell = "SELL 2 (21-60 min) con ma50 > and deviation_ma39 < -0.28 - TOLLERANTE ! - riga 3697"
                        action = "sell"
                        ...
                        sell = "SELL 2 (21-60 min) con ma50 > and (deviation_sell < -0.29 and ma3_last < ma50_last) TOLLERANTE ! - riga 3708"
                        action = "sell"
            ...
            ################################################################################################### SESSIONE 3
                ...
                # VENDITA - da 7 a 12 minuti = da 4200 a 720 secondi
                    ...
                    # e qua mi ha fottuto con la vendita -1.46 al min 6 del 19 dic 2021 - cambiato crollo improvviso ! e cambiato condizioni e anche fascia da 5-12
                        ...
                        sell = "SELL 3 (5-12 min) con ma50 > and incrocio 3-25 and deviation_sell 0.91 - 1.20 - riga 4764"
                        action = "sell"
                ...
                # VENDITA - da 12 a 21 minuti = da 720 a 1260 secondi
                    ...
                    if (
                        ...
                        sell = "SELL 3 (12-21 min) con ma50 > and 3-13 and deviation_sell 0.55-0.90 - DOPPIO PASSO ALLA RONALDO - riga 4901"
                        action = "sell"
                ...
                # VENDITA - da 21 a 60 minuti = da 1261 a 3600 secondi
                    ...
                    ##################################################################### con trend discendente
                        ...
                        sell = "SELL 3 (21-60 min) con ma50 < and deviation_sell < 0.22 - riga 5219"
                        action = "sell"
                ...
                # VENDITA - da 90 minuti in poi = da 5400 secondi in poi
                    ...
                    ########################################################################################################################################### 
                        ...
                        sell = "SELL 3 >90 min con ma50 > con 4 < 20 and deviation_sell 0.57 - 0.90 DRIBBLING ALLA RONALDO - riga 5575"
                        action = "sell"
