        ...
        if self.open and self.session and last_trade_action != "buy":
            ...
            if self.session == 1:
                ...
                # BUY 1 con ma200> piccola CORREZIONE FIAT che NON E' un forte ribasso e NON E' un crollo ! (compare stammi vicino!)
                    ...
                    buy = "BUY 1A con ma200> piccola CORREZIONE FIAT che non e' un forte ribasso e non e' un crollo - riga 793"
                    action = "buy"
                    percentage = 10
                ...
                # copia della riga 530 del RCCR CHE FUNZIONA BENISSIMO ma solo un po' piu' prudente ! - BUY grande ribasso MASERATI CHE NON E' UN CROLLO !
                    ...
                    buy = "copia della riga 530 del RCCR ma piu' prudente ! - BUY GRANDE RIBASSO MASERATI CHE NON E' UN CROLLO ! - riga 911"
                    action = "buy"
                    percentage = 20
                ...
                # BUY 1 GRANDE RIBASSO MASERATI CHE NON E' UN CROLLO ! (compare stammi vicino!) HA FUNZIONATO ! viva ro combaro meo !
                    ...
                    buy = "BUY 1 GRANDE RIBASSO MASERATI CHE NON E' UN CROLLO ! and deviation_bellissima > 0.012- riga 929"
                    action = "buy"
                    percentage = 20
                ...
                # BUY 1 CROLLO FERRARI - modo 1
                    ...
                    buy = "BUY 1 CROLLO FERRARI - modo 1 riga 950"
                    action = "buy"
                    percentage = 20
                ...
                # BUY 1 CROLLO FERRARI - modo 2 questa condizione e' entrata in azione ! ( e mi e' sembrata ben fatta !)
                    ...
                    buy = "BUY 1 CROLLO FERRARI - modo 2 riga 966"
                    action = "buy"
                    percentage = 20
                ...
                # BUY 1 con DEVIATION ASSURDA  se ma200 > da 20 min COMPRA con INCROCIO ma8 - ma200 >
                    ...
                    buy = "BUY 1 con DEVIATION ASSURDA se ma200 > da 120 min COMPRA con INCROCIO ma8 ma200 (ma5>ma300 evita gli EFFETTI LATERALI) - riga 1118"
                    action = "buy"
                    percentage = 20
            ...
            #############################################################################################################      COMPRA sessione 2
                ...
                # BUY 2A PAZZA DURANTE UNA piccola CORREZIONE che NON E' un forte ribasso e NON E' un crollo ! (compare stammi vicino!)
                    ...
                    buy = "BUY 2A PAZZA piccola CORREZIONE che non e' un forte ribasso e non e' un crollo ! con deviation_correzione > 0.02 - riga 1170"
                    action = "buy"
                    percentage = 10
                ...
                # BUY 2 CORREZIONE che NON E' un forte ribasso e NON E' un crollo ! con deviation_correzione > 0.02  696"
                    ...
                    buy = "BUY 2 CORREZIONE che NON E' un forte ribasso e NON E' un crollo ! con deviation_correzione > 0.02 - riga 1192"
                    action = "buy"
                    percentage = 20
                ...
                # BUY 2 FORTE RIBASSO che NON E' UN CROLLO ! (compare stammi vicino!) 
                    ...
                    buy = "BUY 2 FORTE RIBASSO che NON E' UN CROLLO ! and deviation_bellissima > 0.17 -  riga 1211"
                    action = "buy"
                    percentage = 20
            ...
            # forse dal BUY 3 in poi (o dal BUY 4 in poi) ma100 DEVE ESSERE > !
                ...
                if (
                    ...
                    buy = "BUY 3A con ma69 > MA ma200 sale da 60 min - riga 1598"
                    action = "buy"
                    percentage = 50
                    ...
                    buy = "BUY 3A con ma69 > MA ma200 scende da 60 min ! - riga 1626"
                    action = "buy"
                    percentage = 50
                ...
                # BUY 3 PAZZA piccola CORREZIONE FIAT
                    ...
                    buy = "BUY 3 PAZZA piccola CORREZIONE FIAT che non e' un forte ribasso e non e' un crollo ! con deviation_correzione > 0.02 - riga 1445"
                    action = "buy"
                    percentage = 10
            ...
            # ALLA SESSIONE 2 MANCAva UN ACQUISTO DURANTE IL CROLLO SE PER ES SESSIONE 1 HA GIA' VENDUTO MA IL TITOLO RESTA IN IPERVENDUTO
                ...
                # VENDITA - da 21 a 60 minuti = da 1261 a 3600 secondi
                    ...
                    ######################################################################################################## 2 righe del compa GIA' CON TOLLERANZA
                        ...
                        sell = "sessione 2 SELL (21-60 min) con ma50 < and deviation_ma39 < -0.27 - riga 3826"
                        action = "sell"
                        ...
                        sell = "sessione 2 SELL (21-60 min) con ma50 < and deviation_sell < -0.30 - riga 3833"
                        action = "sell"
                    ...
                    # divido in 2 parti la correzione del maestro !
                        ...
                        sell = "SELL 2 compa (21-60 min) con ma50 < and deviation_ma39 < -0.29   con > PERDITA TOLLERATA ! - riga 3869"
                        action = "sell"
                        ...
                        sell = "SELL 2 compa (21-60 min) con ma50 < and deviation_sell < -0.30 con > PERDITA TOLLERATA ! - riga 3879"
                        action = "sell"
            ...
            ################################################################################################### SESSIONE 3
                ...
                # VENDITA - da 21 a 60 minuti = da 1261 a 3600 secondi
                    ...
                    # divido il maestro in 2
                        ...
                        sell = "SELL 3 compa (21-60 min) con ma50 < and deviation_ma39 < -0.26 con PERDITA TOLLERATA > - riga 5262"
                        action = "sell"
                        ...
                        sell = "SELL 3 compa (21-60 min) con ma50 < and deviation_sell < 0.27  con PERDITA TOLLERATA > - riga 5273"
                        action = "sell"
