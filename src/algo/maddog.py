    ...
    def action(self):
        ...
        if self.open and self.session and last_trade_action != "buy":
            ...
            if self.session == 1:
                ...
                # ------------------------------------------------------------  BUY 1 con incrocio 11-69 and ma69_last >= ma69_2_min_ago  "MI PIACE!"
                    ...
                    buy = "BUY 1 con ma20_last > ma200_last e con 11 > 59 e ma69> 2 min ago (!) con DOPPIO DELTA 300-225 GIORNO ! - r 2065"
                    action = "buy"
                    percentage = 80
                ...
                # BUY 1 CHE MANCAVA DOPO 5 ore di ribasso
                    ...
                    buy = "BUY 1 CHE MANCAVA DOPO 5 ore di ribasso con delta 1 < delta 2 (piu' sicuro) e con 5-28 > 0.16  MA 5 non lontana da 100 - r 4040 A"
                    action = "buy"
                    percentage = 80
            ...
            #############################################################################################################      COMPRA sessione 2
                ...
                if (
                    ...
                    buy = "BUY 2A rialzo o laterale con 78 > 200 - r 4639 A2"
                    action = "buy"
                    percentage = 80
            ...
            # deviation_buy3 = ma4_last/ma30_last 
                ...
                if (
                    ...
                    buy = "BUY 3A con ma200 che sale da 60 min and ma28_last > ma69_last - r 6016 B"
                    action = "buy"
                    percentage = 80
                ...
                #  BUY 3A con ma69 > MA ma200 scende da 60 min ! and ma300_last > ma300_60_min_ago
                    ...
                    buy = "BUY 3A con ma69 > MA ma200 scende da 60 min ! and ma300_last > ma300_60_min_ago - r 6225"
                    action = "buy"
                    percentage = 80
        ...
        # NON TOCCARE QUESTE RIGHE (DICE CHE STA IN MODO SELL, DEVO VENDERE !)
            ...
            if self.session == 1:
                ...
                # VENDITA - da 12 a 21 minuti = da 720 a 1260 secondi
                    ...
                    # RAFFORZATO DA 100>300
                        ...
                        sell = "SELL 1 (12-21 min) con ma50 < and deviation_ma39 < -0.159 and deviation_sell < -0.355 CON 450> - r 8444 A"
                        action = "sell"
                        ...
                        sell = "SELL 1 (12-21 min) con ma50 < and deviation_ma39 < -0.159 and deviation_sell < -0.35 CON 450< - r 8444 B"
                        action = "sell"
                ...
                # VENDITA - da 21 a 50 minuti = da 1261 a 3000 secondi
                    ...
                    # TREND LATERALE (100/300  <0.69 and >-0.77) NON TOCCARE 
                        ...
                        sell = "SELL 1 NON TOCCARE (21-50 min) con ma50 < con dev_ma39 <-0.17 E dev_sell < -0.215 TREND LATERALE (100>300 <0.69 and >-0.77) - r 9016b"
                        action = "sell"
                ...
                # VENDITA - da 90 minuti a 110 minuti  = da 5400 secondi a 6600 secondi
                    ...
                    # con or IL MAESTRO HA FATTO LA CORREZIONE ! questa che vedi e' stata corretta dal maestro
                        ...
                        sell = "SELL 1 90-110 min con ma50 < and ma100 < and (dev_sell < -0.16 and ma3_last < ma39_last) and 300 < 120 min ago - r 10170 A"
                        action = "sell"
                        ...
                        sell = "SELL 1 90-110 min con ma50 < and ma100 < and (deviation_sell < -0.142 and ma3_last < ma39_last) 300 < 120 min ago - r 10170 B"
                        action = "sell"
                ...
                # VENDITA - da 110 minuti in poi = da 6601 secondi in poi
                    ...
                    #################################################################################################
                        ...
                        sell = "SELL 1 >110 min con 300 < 5 ore ago E con ma50 > E incr 8-110 se 100-200 < 0.45 and dev_sell 0.65 - 1.49 RABONA RONALDO - r 10358 B"
                        action = "sell"
                        ...
                        sell = "SELL 1 dopo 110 min con ma50 > incrocio 3-125 CON 100 sopra 300 > 0.40 and deviation_sell  1.50-2.70 DOPPIO PASSO RONALDO - r 10382 A"
                        action = "sell"
                    ...
                    # con or IL MAESTRO HA FATTO LA CORREZIONE ! questa che vedi e' stata corretta dal maestro
                        ...
                        sell = "SELL 1 dopo 110 min con ma50 < and ma100 < E 300 < 300 120 min ago and (dev_sell < -0.218 and ma3_last < ma39_last) - r 10456 b"
                        action = "sell"
                    ...
                    # ma se ma100 >
                        ...
                        sell = "SELL 1 dopo 110 min con ma50 < MA ma100 > E ma300 > e con 5-125 - r 10472 A1x"
                        action = "sell"
                        ...
                        sell = "SELL 1 dopo 110 min con ma50 < MA ma100 > E ma300 > e con 3-125 - r 10472 A1y"
                        action = "sell"
                        ...
                        sell = "SELL 1 dopo 110 min con ma50 < MA ma100 > E ma300 < e con deviation_ma39 <-0.193 - r 10472 B1"
                        action = "sell"
                        ...
                        sell = "SELL 1 dopo 110 min con ma50 < MA ma100 > E ma300 < e con deviation_ma39 <-0.193 and dev sell < -0.07 - r 10472 B2"
                        action = "sell"
                    ...
                    # ma se ma100 >
                        ...
                        sell = "SELL 1 dopo 110 min con ma50 < MA ma100 > and (deviation_sell < -0.27 and ma3_last < ma39_last) - r 10489 a1"
                        action = "sell"
                        ...
                        sell = "SELL 1 dopo 110 min con ma50 < MA ma100 > and (deviation_sell < -0.27 and ma3_last < ma39_last) - r 10489 a2"
                        action = "sell"
                    ...
                    # ATTENZIONE 4 ! > 110 min E CON 300 < 120 min FORSE E' NECESSARA SOLO QUESTA !
                        ...
                        sell = "SELL 1 > 110 min con 5 < 200 MA 100 > 300 ! FORSE E' NECESSARA SOLO QUESTA 4 ! deviation_sell < -0.16 - r 10655 B1"
                        action = "sell"
            ...
            # ALLA SESSIONE 2 MANCAva UN ACQUISTO DURANTE IL CROLLO SE PER ES SESSIONE 1 HA GIA' VENDUTO MA IL TITOLO RESTA IN IPERVENDUTO
                ...
                # VENDITA - da 21 a 60 minuti = da 1261 a 3600 secondi
                    ...
                    # divido in 2 parti la correzione del maestro !
                        ...
                        sell = "SELL 2 (21-60 min) con ma50 < and deviation_sell < -0.37 con > PERDITA TOLLERATA ! - r 11755 A"
                        action = "sell"
                ...
                # VENDITA - da 60 a 90 min - da 3600 a 5400 secondi in poi
                    ...
                    if (    
                        ...
                        sell = "SELL 2 da 60 a 90 min con ma50 > and deviation_ma39 <-0.23 - r 11864 A"
                        action = "sell"
                        ...
                        sell = "SELL 2 da 60 a 90 min con ma50 > and deviation_ma39 <-0.22 - r 11864 B"
                        action = "sell"
                    ...
                    ######################################################################################## trend discendente con POCA PERDITA TOLLERATA
                        ...
                        sell = "SELL 2 da 60 a 90 min TREND < con POCA PERDITA TOLLERATA con ma50 < con deviation_ma39 <-0.17 and dev_sell < -0.20 - r 12037 c"
                        action = "sell"
                ...
                # VENDITA 2 - da 110 minuti in poi = da 6601 secondi in poi
                    ...
                    ################################################################################### fare maradona 1 e maradona 2 se ma2 sta sopra ma100
                        ...
                        sell = "SELL 2 dopo 110 min con ma50 > incrocio 3-125 and deviation_sell 1.50 - 2.70 - r 12572"
                        action = "sell"
            ...
            #######################################################################################################
                ...
                # VENDITA - da 90 minuti in poi = da 5400 secondi in poi
                    ...
                    if (    
                        ...
                        sell = "SELL 4-5-x (12-21 min) con ma50 > and 100 > 100 120 min ago and 5-59 and deviation_sell 0.25-0.56 - FINTA ALLA MARADONA - r 15825 A"
                        action = "sell"
                        ...
                        sell = "SELL 4-5-x (12-21 min) con ma50 > and 5-25 and 100 < 100 120 min ago and deviation_sell 0.25-0.56 - FINTA ALLA MARADONA - r 15825 B"
                        action = "sell"
                        ...
                        # 29 ott 2022 4-125 da 4-20 con 5-300 > 0.50
                        ...
                        sell = "SELL 4-5-x >90 min con ma50 > con 4 < 20 and deviation_sell 0.35 - 0.90 FINTA ALLA RONALDO - r 15839 B"
                        action = "sell"
                    ...
                    ######################################################################################## con trend discendente
                        ...
                        sell = "SELL 4-5-x dopo 90 min con ma50 < con deviation_ma39 < -0.235 and 100 > 100 120 min ago - r 15893 A"
                        action = "sell"
            ...
            # 17 - SELL condizione speciale dopo crollo improvviso del 24 aprile 2022 ! and deviation_ma5_sotto_ma200 > -1.00
                ...
                and deviation_crollo_24_aprile < -0.54
                
                and deviation_ma5_sotto_ma200 > -1.00
            ): 
                
                sell = "SELL cond. special 17 -0.54% - DOPO CROLLO IMPROVVISO del 24 aprile 2022 - and dev_ma5_sotto_ma200 > -1.00 - giorno E 33>78 - r 16369 A1"
                action = "sell"
            ...
            # 19 - SELL condizione speciale dopo il crollo improvviso del 24 aprile 2022 ! and deviation_ma5_sotto_ma200 > -1.00
                ...
                and deviation_crollo_24_aprile < -0.548
                
                and deviation_ma5_sotto_ma200 > -1.00
            ): 
                
                sell = "SELL cond. special 19 - DOPO IL CROLLO IMPROVVISO del 24 aprile 2022 - and deviation_ma5_sotto_ma200 > -1.00 - (-0.548) notte - r 16427 b"
                action = "sell"
            ...
            # 32 B2b - SELL condizione speciale ROOT DOWN DEEP - ro cano VENDE dopo 150 min e fino a 240 min con 5-90
                ...
                sell = "SELL condizione speciale 32 ROOT DOWN DEEP - ro cano VENDE dopo 150 min e fino a 240 min con 5-90 - r 16724"
                action = "sell"
            ...
            # 32 SELL condizione speciale ROOT DOWN DEEP - ro cano VENDE dopo 150 min = 9000 sec con 5-90
                ...
                sell = "SELL condizione speciale 32 B ROOT DOWN DEEP - ro cano VENDE dopo 150 min = 9000 sec con 5-90 - r 16734 A"
                action = "sell"
                ...
                sell = "SELL condizione speciale 32 B ROOT DOWN DEEP - ro cano VENDE dopo 150 min = 9000 sec - r 16734 B"
                action = "sell"
