        ...
        #######################################################################
                ...
                if self.session == 1:
                    if (
                        ...
                        and ma13_prev < ma78_prev and ma13_last > ma78_last and ma2_last > ma2_2_min_ago or ( deviation_buy1 > 0.20 and ma2_last > ma2_2_min_ago )
                        and ma18_prev < ma78_prev and ma18_last > ma78_last and ma2_last > ma2_2_min_ago or ( deviation_buy1 > 0.20 and ma2_last > ma2_2_min_ago )
       ...
       ###############################################################################################################################################     
            ...
            # VENDE sessione 2
                ...
                if (
                    ...
                    ma2_last < ma39_last and deviation_sell < -0.35 or (ma3_last < ma39_last and deviation_buy1 < -0.45) or (ma2_last < ma50_last and deviation_ma50 < -0.45)
                    #deviation_sell = ma2_last / ma78_last
                    #deviation_buy1 = (ma8_last / ma78_last
            ...
            if ma2_last < ma39_last and deviation < -0.72:
                action = "sell"
