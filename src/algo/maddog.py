        ...
        if self.open and self.session and last_trade_action != "buy":
            ...
            if self.session == 1:
                ...
                # BUY 1 con DEVIATION ASSURDA  se ma200 > da 20 min COMPRA con price - ma200 >
                    ...
                    buy = "BUY 1 con DEVIATION ASSURDA se ma200 > da 20 min COMPRA con price - ma200 - riga 755"
                    action = "buy"
                    percentage = 20
            ...
            #############################################################################################################      COMPRA sessione 2
                ...
                # BUY 2 DURANTE UN RIBASSO che NON E' UN CROLLO ! (compare stammi vicino!) 
                    ...
                    buy = "BUY 2 DURANTE UN RIBASSO che NON E' UN CROLLO ! and deviation_bellissima > 0.17 -  riga 863"
                    action = "buy"
                    percentage = 20
            ...
            if self.session == 1:
                ...
                # VENDITA - da 12 a 21 minuti = da 720 a 1260 secondi
                    ...
                    ##################################################################### con trend discendente
                        ...
                        sell = "sessione 1 SELL (12-21 min) con ma50 < and deviation_ma39 < -0.163 - riga 1642"
                        action = "sell"
                ...
                # VENDITA - da 60 a 90 min - da 3600 a 5400 secondi in poi
                    ...
                    ######################################################################################## con trend discendente
                        ...
                        sell = "sessione 1 SELL da 60 a 90 min con ma50 < con deviation_ma39 <-0.19 and deviation_sell < -0.195 (no ma3<ma33) (NO INCROCIO!) - riga 1968"
                        action = "sell"
