        ...
        if self.open and self.session and last_trade_action != "buy":
            ...
            if self.session == 1:
                ...
                # BUY 1 migliore che considera distanza 5-300 AND dev 10-200 < -0.24 AND 8-59 - riga 1043 B
                    ...
                    and deviation_ma5_sotto_ma300 < -0.40
                    and deviation_ma5_sopra_ma59 < -0.17
                    ...
                    buy = "BUY 1 migliore che considera distanza 5-300 AND dev 10-200 < -0.24 AND 8-59 - riga 1043 B2"
                    action = "buy"
                    percentage = 50
            ...
            if self.session == 1:
                ...
                # VENDITA - da 110 minuti in poi = da 6601 secondi in poi
                    ...
                    # ma se ma100 >
                        ...
                        sell = "SELL 1 dopo 110 min con ma50 < MA ma100 > E ma300 > e con deviation_ma39 < -0.197 - r 10472 A"
                        action = "sell"
