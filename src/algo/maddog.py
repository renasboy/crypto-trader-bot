    ...
    def action(self):
        ...
        #######################################################################
                ...
                # COMPRA sessione 2
                    ...
                    if (
                        ...
                        #allora tolgo la deviation e lascio solo price 1 min ago e price 2 min ago per vedere se funziona !
        ...
        # NON TOCCARE QUESTA CONDIZIONE (QUESTA DICE CHE STA IN MODO SELL, DEVO VENDERE)
            ...
            # VENDE sessione 2
                ...
                if (
                    ma100_last > ma100_13_min_ago
                    and ma3_last < ma15_last and deviation > 0.35
            ...
            if deviation < -0.55 and ma2_last < ma18_last :
                action = "sell"
