...
####################################          copia CCR che funziona - non so perche' MADDOG NON FUNZIONAVA PIU'
                                   ...
                                   #          + sell 12-14 min e 14-24 min con ma50< : aggiunto "or ma3<ma100" (con le condizioni precedenti aveva fatto -0.61 !)
                                   #          + deviation ma100 per il sell 12-14 e sell 14-24 perche' 3<100 tocca facilmente e separato invece di or
                                   #          + ma devo togliere le ultime 2 perche' venderebbe durante il crollo ! anzi no
                                   #          + MA se metto l' incrocio ma3 ma100 NON INCROCERANNO MAI PERCHE' MA100 STARA' MOLTO SOPRA !
                                              # a questo punto posso mettere incrocio ma5-ma100
        ...
        # NON TOCCARE QUESTA RIGA (DICE CHE STA IN MODO SELL, DEVO VENDERE !)
            ...
            # VENDITA - da 3 a 5 minuti = da 180 a 300 secondi
                ...
                if (
                    ...
                    sell = "SELL (3-5 min) con ma50 > 3<13 (NO INCROCIO 3-13) and deviation_sell 0.25 - 0.60 - DRIBBLING ALLA RONALDO - riga 821"
                    action = "sell"
                    ...
                    sell = "SELL (3-5 min) con ma50 > incrocio 3-25 and deviation_sell 0.61 - 1.20 - riga 831"
                    action = "sell"
            ...
            # VENDITA - da 5 a 12 minuti = da 300 a 720 secondi
                ...
                if (
                    ...
                    sell = "SELL (5-12 min) con ma50 > incrocio 5-100 (cuscino di sant' antonio) and deviation_sell < -0.25 - riga 892"
                    action = "sell"
                    ...
                    sell = "SELL (5-12 min) con ma50 > ma3 < ma13 (NO INCROCIO 3-13) and deviation_sell 0.25 - 0.60 - DRIBBLING ALLA RONALDO - riga 904"
                    action = "sell"
                ...
                ###########################################################################     trend in ribasso
                    ...
                    sell = "SELL 12 (5-12 min) con ma50 < and incrocio 3-100 (cuscino di sant' antonio) - riga 936"
                    action = "sell"
            ...
            # VENDITA - da 12 a 24 minuti = da 720 a 1440 secondi
                ...
                if (
                    ...
                    sell = "SELL (12-24 min) con ma50 > and deviation_ma39 < -0.16 - riga 975"
                    action = "sell"
                    ...
                    sell = "SELL (12-24 min) con ma50 > and incrocio 5-100 cuscino di sant' antonio and deviation_sell < 0.30 - riga 975"
                    action = "sell"
                    ...
                    sell = "SELL (12-24 min) con ma50 > ma3 < ma13 (NO INCROCIO 3-13) and deviation_sell 0.25 - 0.60 - DRIBBLING ALLA RONALDO fino a +0.60 - riga 987"
                    action = "sell"
                    ...
                    sell = "SELL (12-24 min) con ma50 > incrocio 3-25 and deviation_sell 0.61 - 1.20 - riga 999"
                    action = "sell"
                ...
                # L' INCROCIO 5-100 MI SALVA ! MA 5<100 VENDE DURANTE IL RIBASSO !
                   ...
                   # incrocio 5-100 no 5<100 altrimenti vende durante il crollo !
                    ...
                    sell = "SELL (12-24 min) con ma50 < and CUSCINO DI SANT' ANTONIO - riga 1018"
                    action = "sell"
            ...
            # VENDITA - da 24 a 60 minuti = da 1080 a 3600 secondi
                ...
                if (
                    ...
                    sell = "SELL (24-60 min) con ma50 > and incrocio 5-100 cuscino di sant' antonio (no 5<100) and deviation_sell < -0.26 - riga 1045"
                    action = "sell"
                    ...
                    sell = "SELL (24-60 min) con ma50 > ma3 < ma13 (NO INCROCIO 3-13) and deviation_sell 0.30 - 0.60 DRIBBLING ALLA RONALDO - riga 1057"
                    action = "sell"
                ...
                ##################################################################### con trend discendente
                    ...
                    sell = "SELL (24-60 min) con ma50 < and INCROCIO 3-100 (no 3<100) CUSCINO DI SANT' ANTONIO - riga 1150"
                    action = "sell"
            ...
            # VENDITA - da 60 a 90 min - da 3600 a 5400 secondi in poi
                ...
                if (
                    ...
                    sell = "SELL dopo 60 min con ma50 > ma3 < ma15 (NO INCROCIO 3-13) and deviation_sell 0.35 - 0.69 DOPPIO PASSO ALLA RONALDO (fatto con ma15 invece che con ma13) - riga 1132"
                    action = "sell"
            ...
            # VENDITA - da 90 minuti in poi = da 5400 secondi in poi
                ...
                if (
                    ...
                    sell = "SELL dopo 90 min con ma50> ma3<ma15 (NO INCROCIO 3-15) and deviation_sell 0.35 - 0.69 DOPPIO PASSO ALLA RONALDO (fatto con ma15 invece che con ma13) - riga 1202"
                    action = "sell"
