...
############################################################################################################################################################################
                ...
                if self.session == 1:
                    ...
                    # BUY 1 DURANTE IL RIALZO MENTRE con LA DEVIATION BUY
                        ...
                        buy = ".................................................................BUY 1 DURANTE IL RIALZO MENTRE con LA DEVIATION BUY "
                        action = "buy"
         ...
         #################################################################################################################################################################
            ...
            # VENDITA - da 12 a 24 minuti = da 720 a 1440 secondi - attenzione da qua in poi e' rimasto "ma2_last < ma2_2_min_ago" che forse dovrai togliere
                ...
                if (
                    ...
                    #ma2_last < ma2_2_min_ago
                    ( ma50_last < ma50_2_min_ago and ( ma3_last > ma78_last and ma3_last < ma78_last )) and ( ma50_last < ma50_2_min_ago and deviation_sell < -0.20 )
            ...
            # VENDITA - da 40 minuti in poi = da 2400 secondi in poi
                ...
                if (
                    ...
                    ma2_last < ma2_2_min_ago
                    and ( ma50_last >= ma50_2_min_ago and ( ma3_last > ma25_last and ma3_last < ma25_last ) and deviation_sell > 0.18 ))
                    #deviation_sell = ma2_last / last_trade_price
