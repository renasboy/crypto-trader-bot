...
class ro_cano_che_ritorna:
    ...
    def action(self):
       ...
       ##############################################################################################################################################################
        ...
        deviation_buy1 = (ma5_last / ma38_last - 1) * 100 if ma38_last else 0
        ...
        deviation_buy3 = (ma5_last / ma38_last - 1) * 100 if ma38_last else 0
        ...
        if ma50_last >= ma50_2_min_ago and deviation_buy1 > -0.07: 
