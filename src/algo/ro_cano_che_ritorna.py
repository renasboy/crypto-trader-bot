    ...
    def action(self):
        ...
        # NON TOCCARE QUESTA CONDIZIONE (QUESTA DICE CHE STA IN MODO SELL, DEVO VENDERE)
            ...
            if seconds_since_last_trade > 0 and seconds_since_last_trade <= 180:
                if deviation > 0.10 and ma2_last < ma5_last and ma33_last > ma33_3_min_ago:
                    action = 'sell'
            ...
            ############################################################################################
                ...
                elif deviation < -0.33 and ma2_last < ma11_last and ma33_last < ma33_3_min_ago:
                    action = 'sell' 
            ...
            ###################################################################################################
                ...
                elif deviation < -0.33 and ma2_last < ma15_last and ma33_last < ma33_3_min_ago:
                    action = 'sell'    
            ...
            ####################################################################################################
                ...
                elif deviation < -0.29 and ma2_last < ma18_last and ma33_last < ma33_3_min_ago:
                    action = 'sell'
