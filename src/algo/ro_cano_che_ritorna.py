...
class ro_cano_che_ritorna:
    ...
    def action(self):
       ...
       ##############################################################################################################################################################
        ...
        deviation_ma = (ma4_last / ma38_last - 1) * 100 if ma50_last else 0
        ...
        # NON TOCCARE QUESTA CONDIZIONE (QUESTA DICE CHE STA IN MODO SELL, DEVO VENDERE)
            ...
            if seconds_since_last_trade > 0 and seconds_since_last_trade <= 180:
                ...
                if (
                    ...
                    ma50_last > ma50_2_min_ago
                    and ma36_last > ma36_2_min_ago
                    and ma2_last < ma13_last and deviation_sell < -0.65
            ...
            # VENDITA - da 18 a 30 minuti = da 1080 a 1800 secondi
                ...
                if (
                    ...
                    ma50_last > ma50_2_min_ago
                    and ma36_last > ma36_2_min_ago
                    and ma2_last < ma16_last and deviation_sell < -0.60
            ...
            # VENDITA - da 30 minuti in poi = da 1800 secondi in poi
                ...
                if (
                    ...
                    ma50_last > ma50_2_min_ago
                    and ma36_last > ma36_2_min_ago
                    and ma2_last < ma17_last and deviation_sell < -0.60
