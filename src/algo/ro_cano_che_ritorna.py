...
#############################################################################################################################################
        ...
        # NON TOCCARE QUESTA CONDIZIONE (QUESTA DICE CHE STA IN MODO SELL, DEVO VENDERE)
            ...
            #    minuti
            #   0 -  3 ----------  ( 3 < 25 and gain > 0.05 ) OR ( 2 < 13 and gain > 0.80 )
            #   3 -  5 ----------- 
            #   5 - 12 ----------- 
         ...
         #################################################################################################################################################################          3-5 min           
            ...
            # VENDITA - da 5 a 12 minuti = da 300 a 720 secondi
                ...
                if (
                    ...
                    ma2_last < ma2_3_min_ago and ( ma13_last >= ma39_last and deviation_sell < -0.75 ) or ( ma50_last < ma50_2_min_ago and deviation_gabbia < -0.35 )
