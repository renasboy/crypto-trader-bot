        ...
        # NON TOCCARE QUESTE RIGHE (DICE CHE STA IN MODO SELL, DEVO VENDERE !)
            ...
            # VENDITA - da 60 a 90 min - da 3600 a 5400 secondi in poi
                ...
                if (
                    ...
                    sell = "sessione 2 SELL da 60 a 90 min con ma50 > and deviation_ma39 <-0.18 (no ma3<ma39) (NO INCROCIO!) (NO and deviation_sell < 0.10 (!)) - riga 2245"
                    action = "sell"
                    # se non ha forza dopo 1 ora e' inutile continuare a sperare !
                    # cuscino dell' angelo custode
                    ...
                    sell = "sessione 2 SELL >60 min con ma50> and incrocio 3-13 and deviation_sell 0.35-0.80 RABONA ALLA RONALDO (fatto con ma15 invece che con ma13)-riga 2260"
                    action = "sell"
            ...
            if seconds_since_last_trade > 0 and seconds_since_last_trade <= 180:
                ...
                if (
                    ...
                    sell = "SELL (0-3 min) con ma50 > and incrocio 3-39 and deviation_sell < -0.23 - riga 2515"
                    action = "sell"
                    ...
                    sell = "SELL (0-3 min) con ma50 > and incrocio 3-33 and deviation_sell 0.25 - 0.60 - riga 2526"
                    action = "sell"
                    ...
                    sell = "SELL (0-3 min) con ma50 > and incrocio 3-33 and deviation_sell 0.61 - 0.79 - riga 2536"
                    action = "sell"
                    ...
                    sell = "SELL (0-3 min) con ma50 > and incrocio 3-13 and deviation_sell 0.80 - 1.20 - riga 2548"
                    action = "sell"
                    ...
                    sell = "SELL (0-3 min) con ma50 > and incrocio 3-11 and deviation_sell > 1.21 (che sarebbe come IL DRIBBLING ALLA RONALDO !)- riga 2559"
                    action = "sell"
                ...
                ###########################################################################     trend in ribasso
                    ...
                    sell = "SELL (0-3 min) con ma50 < and incrocio 3-28- riga 2570"
                    action = "sell"
                ...
                # ---------------------------------------------------------------------------------------------------------------------- crollo
                    ...
                    sell = "SELL CROLLO (0-3 min) con ma50 < and incrocio 3-16 and deviation_sell < -0.50 - riga 2591"
                    action = "sell"
                    ...
                    sell = "SELL CROLLO (0-3 min) con ma50 < and incrocio 3-23 and deviation_sell > 0.23 - riga 2602"
                    action = "sell"
                    ...
                    sell = "SELL CROLLO (0-3 min) con ma50 < and incrocio 3-8 and deviation_sell > 0.60 - riga 2612"
                    action = "sell"
            ...
            # VENDITA - da 3 a 5 minuti = da 180 a 300 secondi
                ...
                if (
                    ...
                    sell = "SELL (3-5 min) con ma50 > and incrocio 3-39 and deviation_sell < -0.24 - riga 2629"
                    action = "sell"
                    ...
                    sell = "SELL (3-5 min) con ma50 > and 3<9 (no incrocio 3-9) and deviation_sell 0.25 - 0.90 - DRIBBLING ALLA RONALDO - riga 2640"
                    action = "sell"
                    ...
                    sell = "SELL (3-5 min) con ma50 > and incrocio 3-25 and deviation_sell 0.91 - 1.20 - riga 2650"
                    action = "sell"
                    ...
                    sell = "SELL (3-5 min) con ma50 > and incrocio 3-25 and deviation_sell > 1.21 - riga 2660"
                    action = "sell"
                ...
                ###########################################################################     trend in ribasso
                    ...
                    sell = "SELL (3-5 min) con ma50 < and incrocio 3-28 - riga 2673"
                    action = "sell"
                    ...
                    sell = "SELL (3-5 min) con ma50 < and incrocio 3-33 and deviation_sell < -0.23 - riga 2684"
                    action = "sell"
                ...
                # ---------------------------------------------------------------------------------------------------------------------- guadagno con crollo
                    ...
                    sell = "SELL GUADAGNO CON CROLLO (3-5 min) con ma50 < and incrocio 3-23 and deviation_sell > 0.23 - riga 2695"
                    action = "sell"
                    ...
                    sell = "PARACADUTE CROLLO (0-3 min) con ma50 < and ma3<ma16 (no incrocio) and deviation_sell < -0.50 - riga 2708"
                    action = "sell"
            ...
            # VENDITA - da 5 a 12 minuti = da 300 a 720 secondi
                ...
                if (
                    ...
                    sell = "SELL (5-12 min) con ma50 > and incrocio 3-78 and deviation_sell < -0.41 - riga 2736"
                    action = "sell"
                ...
                # QUESTO E' IL RISCHIO PIU' GRANDE CHE PRENDO ! ( ma con ma50 > ma50 2 min ago DOPO 5 min (+2))
                    ...
                    sell = "SELL (5-12 min) con ma50 > and incrocio 5-100 (cuscino di sant' antonio) and deviation_sell < -0.25 - riga 2752"
                    action = "sell"
                    ...
                    sell = "SELL (5-12 min) con ma50 > and incrocio 3-25 and deviation_sell 0.91 - 1.20 - riga 2776"
                    action = "sell"
                    ...
                    sell = "SELL (5-12 min) con ma50 > and incrocio 3-25 and deviation_sell > 1.21 - riga 2786"
                    action = "sell"
                ...
                ###########################################################################     trend in ribasso
                    ...
                    sell = "SELL 12 (5-12 min) con ma50 < and incrocio 3-28 - riga 2798"
                    action = "sell"
                    ...
                    sell = "SELL 12 (5-12 min) con ma50 < and incrocio 3-100 (cuscino di sant' antonio) - riga 2811"
                    action = "sell"    
                ...
                # ------------------------------------------------------------------------------- guadagno con crollo
                    ...
                    sell = "SELL guadagno con crollo (5-12 min) con ma50 < and incrocio 3-23 - riga 2824"
                    action = "sell"
                ...
                # ------------------------------------------------------------------------------------------------------------ PARACADUTE crollo   
                    ...
                    sell = "PARACADUTE CROLLO (0-3 min) con ma50 < and ma3<ma16 (no incrocio) and deviation_sell < -0.50 - riga 2836"
                    action = "sell"
            ...
            # VENDITA - da 12 a 21 minuti = da 720 a 1260 secondi
                ...
                if (
                    ...
                    sell = "SELL (12-21 min) con ma50 > and incrocio 3-72 and deviation sell -0.65 e vaffanculo ! - riga 2867"
                    action = "sell"
                    ...
                    sell = "SELL (12-21 min) con ma50 > and incrocio 3-100 cuscino di sant' antonio and deviation_sell < 0.36 - riga 2877"
                    action = "sell"
                    ...
                    sell = "SELL (12-21 min) con ma50 > and 3-13 (NO INCROCIO 3-13) and deviation_sell 0.25 - 0.90 - DOPPIO PASSO ALLA RONALDO fino a +0.50 - riga 2889"
                    action = "sell"
                    ...
                    sell = "SELL (12-21 min) con ma50 > and incrocio 3-25 and deviation_sell 0.91 - 1.20 - riga 2901"
                    action = "sell"
                    ...
                    sell = "SELL (12-21 min) con ma50 > and incrocio 3-39 and deviation_sell > 1.21 - riga 2911"
                    action = "sell"
                ...
                ##################################################################### con trend discendente
                    ...
                    sell = "SELL (12-21 min) con ma50 < and deviation_ma39 < -0.15 - riga 2926"
                    action = "sell"
                    ...
                    sell = "SELL (12-21 min) con ma50 < and incrocio 3-78 and deviation_sell < -0.45 - riga 2945"
                    action = "sell"
                   ...
                   # incrocio 5-100 no 5<100 altrimenti vende durante il crollo !
                    ...
                    sell = "SELL (12-21 min) con ma50 < and CUSCINO DI SANT' ANTONIO - riga 2959"
                    action = "sell"   
                ...
                # --------------------------------------------------------------------------------- PARACADUTE crollo   
                    ...
                    sell = "PARACADUTE CROLLO (12-21min) con ma50< and ma3<ma16 (no incrocio) and deviation_sell < -0.50 - riga 2971"
                    action = "sell"
                ...
                # ----------------------------------------------------------------------------- guadagno con crollo
                    ...
                    sell = "SELL eventuale guadagno con crollo (12-21 min) con ma50 < and incrocio 3 - 18 and deviation_sell > 0.23 - riga 2984"
                    action = "sell"    
            ...
            # VENDITA - da 21 a 60 minuti = da 1261 a 3600 secondi
                ...
                if (
                    ...
                    sell = "SELL (21-60 min) con ma50 > and deviation_ma39 < -0.16 or (deviation_sell < 0.10 and ma3_last < ma50_last) - riga 3012"
                    action = "sell"
                    ...
                    sell = "SELL (21-60 min) con ma50 > and incrocio 5-100 cuscino di sant' antonio (no 5<100) and deviation_sell < -0.26 - riga 3024"
                    action = "sell"
                    ...
                    sell = "SELL (21-60 min) con ma50 > and 3<16 (no incrocio 3-13) and deviation_sell 0.30 - 0.90 ELASTICO ALLA RONALDO - riga 3037"
                    action = "sell"
                    ...
                    sell = "SELL (21-60 min) con ma50 > and incrocio 3-39 and deviation_sell 0.91 - 1.20 - riga 3048"
                    action = "sell"
                    ...
                    sell = "SELL (21-60 min) con ma50 > and incrocio 3-45 and deviation_sell > 1.21 - riga 3061"
                    action = "sell"
                ...
                ##################################################################### con trend discendente
                    ...
                    sell = "SELL (21-60 min) con ma50 < and deviation_ma39 < -0.15 or (deviation_sell < 0.10 and ma3_last < ma39_last) - riga 3078"
                    action = "sell"
                    ...
                    sell = "SELL (21-60 min) con ma50 < and incrocio 3-78 and deviation_sell < -0.37 - riga 3090"
                    action = "sell"
                    ...
                    sell = "SELL (21-60 min) con ma50 < and INCROCIO 3-100 (no 3<100) CUSCINO DI SANT' ANTONIO - riga 3104"
                    action = "sell"
                ...
                # -------------------------------------------------------------------------------------- guadagno durante il crollo
                    ...
                    sell = "SELL eventuale guadagno durante il crollo (21-60 min) con ma50 < incrocio 3 - 18 and deviation_sell > 0.23 - riga 3119"
                    action = "sell"
            ...
            # VENDITA - da 60 a 90 min - da 3600 a 5400 secondi in poi
                ...
                if (
                    ...
                    sell = "SELL da 60 a 90 min con ma50 > and deviation_ma39 <-0.18 (no ma3<ma39) (NO INCROCIO!) (NO and deviation_sell < 0.10 (!)) - riga 3142"
                    action = "sell"
                    # se non ha forza dopo 1 ora e' inutile continuare a sperare !
                    # cuscino dell' angelo custode
                    ...
                    sell = "SELL dopo 60 min con ma50 > and incrocio 3-13 and deviation_sell 0.35 - 0.80 RABONA ALLA RONALDO (fatto con ma15 invece che con ma13) - riga 3157"
                    action = "sell"
                    ...
                    sell = "SELL da 60 a 90 min con ma50 > and incrocio 3-39 and deviation_sell 0.81 - 1.49 - riga 3170"
                    action = "sell"
                    ...
                    sell = "SELL da 60 a 90 min con ma50 > incrocio 3-33 and deviation_sell > 1.50 - riga 3182"
                    action = "sell"
                ...
                ######################################################################################## con trend discendente
                    ...
                    sell = "SELL da 60 a 90 min con ma50 < con deviation_ma39 <-0.18 and deviation_sell < 0.10 (no ma3<ma33) (NO INCROCIO!) - riga 3197"
                    action = "sell"
                # se non ha forza dopo 1 ora e' inutile continuare a sperare !
                # qui non ho messo il crollo perche' dopo 40 min o gia' ha venduto o e' gia' risalita
                # cuscino dell' angelo custode
                    ...
                    sell = "SELL da 60 a 90 min con ma50 < con incrocio 3-78 and deviation_sell < 0.10 - riga 3212"
                    action = "sell"
            ...
            # VENDITA - da 90 minuti in poi = da 5400 secondi in poi
                ...
                if (
                    ...
                    sell = "SELL dopo 90 min con ma50 > and deviation_ma39 <-0.18 (no ma3<ma39) or (deviation_sell < 0.10 and ma3_last < ma50_last) - riga 3234"
                    action = "sell"
                    ...
                    sell = "SELL >90 min con ma50 > con 3<15 and deviation_sell 0.35 - 0.69 RABONA ALLA RONALDO (fatto con ma15 invece che con ma13) - riga 3252"
                    action = "sell"
                    ...
                    sell = "SELL dopo 90 min con ma50 > incrocio 3-48 (!) and deviation_sell 0.70 - 1.49 - riga 3265"
                    action = "sell"
                    ...
                    sell = "SELL dopo 90 min con ma50 > incrocio 3-48 (!) and deviation_sell > 1.50 - riga 3277"
                    action = "sell"
                ...
                ######################################################################################## con trend discendente
                    ...
                    sell = "SELL dopo 90 min con ma50 < con deviation_ma39 <-0.18 or (deviation_sell < 0.10 and ma3_last < ma39_last) - riga 3294"
                    action = "sell"
                # se non ha forza dopo 1 ora e' inutile continuare a sperare !
                # dopo 90 min se il prezzo non ha forza puoi anche prendere qualcosa (solo > 90 min
                # qui non ho messo il crollo perche' dopo 40 min o gia' ha venduto o e' gia' risalita
            ...
            if deviation_ma39 < -0.25 and ma50_last > ma50_2_min_ago:
                ...
                sell = "SELL SALVAGENTE 3-39 con ma50 < riga 3322"
                action = "sell"
            ...
            # 2 - ro cano VENDE DURANTE UN CROLLO IMPROVVISO !
                ...
                sell = "SELL CROLLO IMPROVVISO - riga 3333"
                action = "sell"
            ...
            # 3 - ro cano VENDE " DOPO x MINUTI " "max hold time" - DOLCE ATTESA con ma25 >
                ...
                sell = "SELL DOLCE ATTESA con ma25> and deviation < -0.45 - riga 3349"
                action = "sell"
            ...
            # 4 - ro cano VENDE " DOPO x MINUTI " "max hold time" - DOLCE ATTESA con ma25 <
                ...
                sell = "SELL DOLCE ATTESA con ma25< and deviation < -0.40 - riga 3367"
                action = "sell"
            ...
            # 5 - ro cano VENDE " DOPO x MINUTI " and...
                ...
                sell = "SELL TEMPO e se ma8 < ma50 and deviation_sell < -0.49 - riga 3384"
                action = "sell"
                # ma13 troppo lenta !
                # max_hold_time_in_seconds = 360 = 6 min (con 8 min perdita di 0.70 %)    
