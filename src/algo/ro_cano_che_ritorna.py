    ...
    def action(self):
        ...
        # NON TOCCARE QUESTE RIGHE (DICE CHE STA IN MODO SELL, DEVO VENDERE !)
            ...
            # 4A - SELL condizione speciale ro cano VENDE CON UN SALVAGENTE con deviation_ma5_sotto_ma200 > -1.00
                ...
                sell = "SELL condizione speciale SALVAGENTE 4 deviation 3-39 <-0.27 and deviation<-0.32 - con ma50 < e con ma5 sotto ma200 > -1.00 - r 9390"
                action = "sell"   
            ...
            # 18 - SELL condizione speciale FIAT 
                ...
                sell = "SELL condizione speciale FIAT se > 2 min dal BUY FIAT la perdita e' < -0.30 ! - r 9658"
                action = "sell"
            ...
            # 19 - SELL condizione speciale AUDI 
                ...
                sell = "SELL condizione speciale AUDI se > 2 min dal BUY AUDI la perdita e' < -0.40 - r 9679"
                action = "sell"
            ...
            # 20 - SELL condizione speciale MASERATI 
                ...
                sell = "SELL condizione speciale MASERATI se > 2 min dal BUY MASERATI la perdita e' < -0.50 - r 9698"
                action = "sell"
            ...
            # 21 - SELL condizione speciale FERRARI 
                ...
                sell = "SELL condizione speciale FERRARI se > 2 min dal BUY FERRARI la perdita e' < -0.70 - r 9715"
                action = "sell"
